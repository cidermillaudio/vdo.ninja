Welcome to the translation / language section of URU.ninja
...
There is a file called translate.js, which if you copy/paste the content (and hit enter) into the Chrome browser's console, while on URU.ninja, it will download the translation files.
...
the "blank.json" file contains a minimal template.  Little to no URU.ninja branding.
